    ...
    <section className="section-py bg-secondary/30">
      <div className="container-px mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <h2 className="heading-serif text-3xl md:text-4xl lg:text-5xl font-bold">Booking & Inquiries</h2>
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 mt-8 px-8 py-3.5 rounded-md bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-all hover:gap-3"
          >
